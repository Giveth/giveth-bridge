...
const soliditySourceFileNames = ['CSTokenRegistry.sol'];
soliditySourceFileNames.forEach(soliditySourceFileName => {
    const csTokeContractPath = path.resolve(
        __dirname,
        '..',
        'contracts-new',
        soliditySourceFileName,
    );
